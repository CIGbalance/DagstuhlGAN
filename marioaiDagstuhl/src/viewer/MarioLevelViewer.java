...
public class MarioLevelViewer {
	...
	public static void main(String[] args) throws IOException {
		...
		/*if (args.length > 0) {
			...
			level = eval.levelFromLatentVector(new double[] {0.72484928, 0.65898222, 1.20797835, -0.14839157, 0.96254385, -0.07363058, 0.56124159, 1.56701652, -0.04941966, -0.21348881});
		}

		saveLevel(level, "LevelClipped_f26", true);
